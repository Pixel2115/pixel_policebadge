...
RegisterNetEvent("pixel_badge:show")
AddEventHandler("pixel_badge:show", function(sid, metadata)
    ...
    if distance <=  5.0 then
        ...
        TriggerEvent('chat:addMessage',  { color = { 242, 159, 252}, multiline = false, args = { "The citizen ["..sid.."] pulls out a badge and shows it: ["..metadata.badge.."] "..metadata.data.." ("..metadata.grade..")" } })
    end
end)
